        ...
        <div className="overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <InfoItem title="Morto">
              Uma pilha de {rules.cards_in_dead_pile} cartas que uma dupla pega
              quando um de seus jogadores fica sem cartas na mão. Cada dupla só
              pode pegar um morto.
            </InfoItem>
            ...
            <InfoItem title="Canastra">
              Um jogo com {rules.min_cards_for_canastra} ou mais cartas. Fazer
              canastras é essencial para uma boa pontuação.
            </InfoItem>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <InfoItem
              title={`Canastra Limpa (${rules.points_clean_canastra} pts)`}
            >
              {rules.min_cards_for_canastra} ou mais cartas em sequência, sem
              usar nenhum curinga.
            </InfoItem>
            <InfoItem
              title={`Canastra Suja (${rules.points_dirty_canastra} pts)`}
            >
              Uma canastra que inclui um curinga (carta '2' ou Joker).
            </InfoItem>
            <InfoItem
              title={`Canastra Real (${rules.points_king_canastra} pts)`}
            >
              Uma canastra limpa de Ás a Rei ({rules.max_length - 1} cartas).
            </InfoItem>
            <InfoItem
              title={`Canastra Completa (${rules.points_ace_canastra} pts)`}
            >
              Uma canastra limpa de Ás a Ás ({rules.max_length} cartas), sem
              curingas.
            </InfoItem>
          </div>
          ...
          <ul className="space-y-3 text-base">
            <li className="flex items-center justify-between bg-white/5 p-3 rounded-lg">
              ...
              <span className="font-bold text-green-400">
                {rules.points_for_ending} pontos
              </span>
            </li>
            <li className="flex items-center justify-between bg-white/5 p-3 rounded-lg">
